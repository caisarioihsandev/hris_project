...
class Payroll:
    ...
    def hitung(data, hari_kerja):
        ...
        pot_alpha = premi_kehadiran * alpha
        pot_telat = premi_kehadiran * 0.5 * telat
        pot_absen = pot_alpha + pot_telat

        upah_penuh = upah_tetap + tunj_makan + tunj_transport
        ...
        # Pajak
        biaya_jabatan = min(0.05 * upah_penuh, 500000)
        ...
        with db.cursor() as cursor:
            cursor.execute("""
                ...
                (id_karyawan, periode, tot_hari_kerja, gaji_pokok, tunj_jabatan,
                 upah_tetap, tunj_makan, tunj_tranport, tot_premi_kehadiran,                 
